    ...
    <div id="full_page_viberent_plugin">
        ...
        if (!empty($resulu)) {
            if ($resulu[0]->selected_layout == "item-based") {
                $page_id = create_page('Viberent based listing');
        ...
        ?>
            <div id="chosen_message" style="display:none;">
                <a href="<?php echo site_url(); ?>/viberent-based-listing" type="button" target="_blank" id="change_selected_layout" name="change_selected_layout">Go to the <?php echo $my_selected_layout[0]->selected_layout; ?> layout </a>
            </div>
        <?php
        }
        ?>
