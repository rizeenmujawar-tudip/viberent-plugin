    ...
    <div id="main-container" class="container">
        <div id="shopping-cart">
            <div id="my-shopping-cart">
                ...
                <div id="my_shop_nav">
                    <a id="btn_mycart" class="btn_mycart" target="_blank" href="<?php echo site_url() . "/index.php/my-cart/" ?>">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-12 col-md-6 offset-md-3 offset-lg-0">
                ...
                <div class="categories">
                    ...
                    <ul>
                        <li class="active">
                            <a href="<?php echo site_url(); ?>/viberent-based-listing/?category=all&pageno=1" class="all_category_btn" name="selected_category_btn">All Categories</a>
                        </li>
                        <?php
                        ...
                        ?>
                            <li class="<?php if ($sucategoryName == $retrieved_data1["subCategoryName"]) {
                                ...
                                <a href=<?php echo site_url() . "/index.php/viberent-based-listing/?category=" . $retrieved_data1["subCategoryName"] . "&pageno=1" ?> class="selected_category_btn" name="selected_category_btn"><?php echo $retrieved_data1["subCategoryName"]; ?></a>
                            <?php
                        }
                            ?>
                            </li>
            ...
            ?>
                <div class="col-lg-9 col-sm-12 col-md-12">
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <div id="col-catwise-items" class="col-catwise-items">
                                <h2 class="new-booking">New Booking: <span>
                                ...
                                ?>
                                    ...
                                    <div class="item-category-box ng-star-inserted" id="catwise-item-box">
                                        <form method="post" action="<?php echo site_url(); ?>/viberent-based-listing/?category=<?php echo $query['category']; ?>&pageno=<?php echo $query['pageno']; ?>&action=add&code=<?php echo $retrieved_datas['itemCode']; ?>">
                                                                                            ...
                                                                                            if (isset($_SESSION["cart_item"])) {
                                                                                                foreach ($_SESSION["cart_item"] as $item) {
                                                                                                    ...
                                                                                                    if ($retrieved_datas['itemCode'] == $item['code']) {
                                                                                                        echo $productAvailable . " item(s) added to cart";
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                            ?></div>
                                ...
                                <div class="pagination">
                                    <ul>
                                        ...
                                        if ($total_pages_cat > 1) {
                                            if ($page_no_cat >= 2) {
                                                echo "<li class='prev'><span><a href='" . site_url() . "/viberent-based-listing/?category=" . $query['category'] . "&pageno=" . ($page_no_cat - 1) . "'>Prev</a></span></li>";
                                            }

                                            for ($x = 1; $x <= $page_no_cat; $x++) {

                                                if ($x == $page_no_cat) {
                                                    $pagLink_category .= "<li class='active'><span><a href='" . site_url() . "/viberent-based-listing/?category=" . $query['category'] . "&pageno="
                                                        . $x . "'>" . $x . " </a></span></li>";
                                                } else {

                                                    $pagLink_category .= "<li><span><a href='" . site_url() . "/viberent-based-listing/?category=" . $query['category'] . "&pageno=" . $x . "'>   
                                                " . $x . " </a></span></li>";
                                                }
                                            }
                                            ...
                                            if ($page_no_cat < $total_pages_cat) {
                                                ...
                                                $pagLink_category .= "<li><span><a href='" . site_url() . "/viberent-based-listing/?category=" . $query['category'] . "&pageno=" . ($page_no_cat + 1) . "'>Next</a></span></li>";
                                            }
                    ...
                    <div id="col-all-items" class="col-all-items">
                        ...
                        <h2 style="padding-left: 20px;">New Booking: <span>
                        ...
                        ?>
                            ...
                            <div class="item-category-box ng-star-inserted" id="all-item-box">
                                <form method="post" action="<?php echo site_url();
                                                            if (isset($query['pageno'])) { ?>/viberent-based-listing/?pageno=<?php echo $query['pageno'];
                                                                                                                            } else { ?>/viberent-based-listing/?pageno=1<?php } ?>&action=add&code=<?php echo $retrieved_data['itemCode']; ?>">
                        ...
                        <div class="pagination">
                            <ul>
                                ...
                                if ($total_pages > 1) {
                                    if ($page_nos >= 2) {
                                        echo "<li class='prev'><span><a href='" . site_url() . "/viberent-based-listing/?pageno=" . ($page_nos - 1) . "'>Prev</a></span></li>";
                                    }
                                    ...
                                    for ($x = 1; $x <= $page_nos; $x++) {
                                        ...
                                        $query_result = http_build_query($query);
                                        if ($x == $page_nos) {
                                            $pagLink .= "<li class='active'><span><a href='" . site_url() . "/viberent-based-listing/?pageno="
                                                . $x . "'>" . $x . " </a></span></li>";
                                        } else {
                                            $pagLink .= "<li><span><a href='" . site_url() . "/viberent-based-listing/?pageno=" . $x . "'>   
                                                        " . $x . " </a></span></li>";
                                        }
                                    }
                                    ...
                                    if ($page_nos < $total_pages) {
                                        ...
                                        $pagLink .= "<li><span><a href='" . site_url() . "/viberent-based-listing/?pageno=" . ($page_nos + 1) . "'>Next</a></span></li>";
                                    }
                                    echo $pagLink;
                                }
                                ?>
