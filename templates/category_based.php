                    ...
                    <div class="categories">
                        ...
                        <ul>
                            <li class="all_category_btn_list">
                                <a href="<?php echo esc_url(site_url() . "/" . $mypagename . "/?category=all&pageno=1");?>" class="all_category_btn" name="selected_category_btn">All Categories</a>
                            </li>
                            <?php
                            ...
                            ?>
                                <li class="<?php if ($sucategoryName == $retrieved_data1["subCategoryName"]) {
                                    ...
                                    <a href="<?php echo esc_url(site_url() . "/" . $mypagename . "/?category=" . $retrieved_data_query . "&pageno=1"); ?>" class="selected_category_btn" name="selected_category_btn">
                            ...
                            <div class="viberentPagination">
                                <ul>
                                    ...
                                    if ($total_pages_cat > 1) {
                                        if ($page_no_cat >= 2) {
                                            echo "<li class='prev'><a href='" . esc_url(site_url() . "/" . $mypagename . "/?category=" . $query['category'] . "&pageno=" . ($page_no_cat - 1) ). "'><span>Prev</span></a></li>";
                                        }
                                        for ($x = 1; $x <= $page_no_cat; $x++) {
                                            if ($x == $page_no_cat) {
                                                $pagLink_category .= "<li class='active'><a href='" . esc_url(site_url() . "/" . $mypagename . "/?category=" . $query['category'] . "&pageno="
                                                    . $x ). "'><span>" . $x . " </span></a></li>";
                                            } else {
                                                $pagLink_category .= "<li><a href='" . esc_url(site_url() . "/" . $mypagename . "/?category=" . $query['category'] . "&pageno=" . $x ). "'><span>   
                                            " . $x . " </span></a></li>";
                                            }
                                        }
                                        if ($page_no_cat < $total_pages_cat) {
                                            $pagLink_category .= '<li class="disabled"><span>...</span></li>';
                                            $pagLink_category .= "<li><a href='" . esc_url(site_url() . "/" . $mypagename . "/?category=" . $query['category'] . "&pageno=" . ($page_no_cat + 1) ). "'><span>Next</span></a></li>";
                                        }
                    ...
                    <div id="col-all-items" class="col-all-items">
                        ...
                        <div class="viberentPagination">
                            <ul>
                                ...
                                if ($total_pages > 1) {
                                    if ($page_nos >= 2) {
                                        echo "<li class='prev'><a href='" . esc_url(site_url() . "/" . $mypagename . "/?pageno=" . ($page_nos - 1) ). "'><span>Prev</span></a></li>";
                                    }
                                    for ($x = 1; $x <= $page_nos; $x++) {
                                        $query['pageno'] =  $x;
                                        $query_result = http_build_query($query);
                                        if ($x == $page_nos) {
                                            $pagLink .= "<li class='active'><a href='" . esc_url(site_url() . "/" . $mypagename . "/?pageno="
                                                . $x ). "'><span>" . $x . " </span></a></li>";
                                        } else {
                                            $pagLink .= "<li><a href='" . esc_url(site_url() . "/" . $mypagename . "/?pageno=" . $x ). "'><span>   
                                                    " . $x . " </span></a></li>";
                                        }
                                    }
                                    if ($page_nos < $total_pages) {
                                        $pagLink .= '<li class="disabled"><span>...</span></li>';
                                        $pagLink .= "<li><a href='" . esc_url(site_url() . "/" . $mypagename . "/?pageno=" . ($page_nos + 1) ). "'><span>Next</span></a></li>";
                                    }
                                    echo $pagLink;
                                }
                                ?>
